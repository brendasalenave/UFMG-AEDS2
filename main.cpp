...
//ENTRAREMOS COM A CHAVE (PALVRA) E RETORNAR� O VALOR(TEXTO QUE POSSUI O A PALAVRA)
void buscar(MAPA&, string);
//Insere as palavras dos arquivos no indice
void Nova_palavra(MAPA&, string , string );
//RECEBE O ARQUIVO ATUAL E EXECUTA A LEITURA DAS PALAVRAS, J� CORRIGINDO-AS E MANDANDO ELAS PRO INDICE
void ler_palavras(ifstream&, MAPA&, string&);
//IR� RETORNAR OS ARQUIVOS(VALORES) PARA QUAL AQUELA PALAVRA(CHAVE) PERTENCE. ISTO, CASO A PALAVRA ESTEJA CONTIDA EM ALGUM DOS ARQUIVOS
